...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './arml-game.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARMLGAME_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARMLGAME actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARMLGAME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARMLGAME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARMLGAME actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARMLGAME actions', async () => {
      const arg = 42666;
