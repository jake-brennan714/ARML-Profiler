...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARMLPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARMLPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARMLPROFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARMLPROFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARMLPROFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARMLPROFILE actions', async () => {
      const arg = 42666;
