...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARMLGAMESCORE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARMLGAMESCORE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARMLGAMESCORE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARMLGAMESCORE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARMLGAMESCORE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARMLGAMESCORE actions', async () => {
      const arg = 42666;
