...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARMLPLAYER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARMLPLAYER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARMLPLAYER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARMLPLAYER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARMLPLAYER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARMLPLAYER actions', async () => {
      const arg = 42666;
