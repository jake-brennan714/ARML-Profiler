...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, net.jakebrennan.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, net.jakebrennan.repository.UserRepository.USERS_BY_EMAIL_CACHE);
